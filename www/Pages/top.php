...
?>
     <div class='container'>
         <main>
            ...
            <h2 class="h2GO">あなたの健康への第一歩を後押しする。</h2>
            <div class="GO">
                <article class="reserchGO">
                    <h3 class="h3GO">利用登録は簡単</h3>
                    <p>
                        簡単なプロフィールを入力するだけ。<br/>
                        すぐに始めよう。ザ・健康ライフ。
                    </p>
                ...
                <article class="reserchGO">
                    <h3 class="h3GO">あなたの頑張りを入力するだけ</h3>
                    <p>
                ...
                <article class="reserchGO">
                    <h3 class="h3GO">日々の頑張りでポイントが貯まる</h3>
                    <p>
                ...
                <article class="reserchGO">
                    <h3 class="h3GO">日々の頑張りがランキングに</h3>
                    <p>
                        あなたの頑張りがランキングに。<br/>
